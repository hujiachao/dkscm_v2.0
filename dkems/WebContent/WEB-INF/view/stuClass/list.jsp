			...
			<div class="row">
				<div class="col-md-12">
					<table class="table table-bordered table-hover">
						...
						<tbody>
							<c:forEach var="stuClass" items="${page.list }" varStatus="s">
								<tr>
									<td align="center">${(page.pageNum - 1) * page.pageSize + s.count }</td>
									<td align="center">${stuClass.stuClassNo }</td>
									<td align="center">${stuClass.sortOrder }</td>
									<td align="center">${stuClass.createTime }</td>
									<td align="center">
										<a href="../stuClass/detialData.do?stuClassId=${stuClass.stuClassId }" class="btn btn-success btn-xs">详情</a>
										<a href="../stuClass/updateForm.do?stuClassId=${stuClass.stuClassId }" class="btn btn-warning btn-xs">修改</a>
										<a href="../stuClass/delete.do?stuClassId=${stuClass.stuClassId }" class="btn btn-danger btn-xs">删除</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
